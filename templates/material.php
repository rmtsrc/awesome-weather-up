<div id="<?php awe_widget_id($weather); ?>" class="<?php echo $background_classes ?>" <?php echo $inline_style; ?>>
	...
	<?php if ($weather->background_image) { ?><div class="awesome-weather-up-cover" style="background-image: url(<?php echo $weather->background_image; ?>);"><?php } ?>

		<?php awe_change_weather_form($weather); ?>

		<div class="awesome-weather-up-header awecf"><span><?php echo $header_title; ?><?php awe_change_weather_trigger($weather); ?></span></div>

		<?php if (isset($weather->data['current'])) { ?>

			<div class="awesome-weather-up-currently">
				<div class="awesome-weather-up-darken awecf">
					<div class="awesome-weather-up-current-temp"><strong><?php echo $weather->data['current']['temp']; ?><sup>&deg;</sup></strong></div>
					<div class="awesome-weather-up-current-conditions">
	...
	<?php if ($weather->show_stats or $weather->forecast_days != "hide") { ?><div class="awe-material-details"><?php } ?>
		...
		<?php if ($weather->forecast_days != "hide") { ?>
			...
			<div class="awesome-weather-up-forecast awe_days_<?php echo count($weather_forecast); ?> awecf">

				<?php foreach ($weather_forecast as $forecast) { ?>
					<div class="awesome-weather-up-forecast-day">
						<div class="awesome-weather-up-forecast-day-abbr"><small><?php echo $forecast->day_of_week; ?></small></div>
						<?php if ($weather->show_icons) { ?><i class="<?php echo $forecast->icon; ?>"></i><?php } ?>
						<div class="awesome-weather-up-forecast-day-temp"><strong><small><?php echo $forecast->high; ?><sup>&deg;</sup></small></strong></div>
					</div>
				<?php } ?>
		...
		<?php if ($weather->show_stats or $weather->forecast_days != "hide") { ?>
		</div><?php } ?>

</div><!-- /.awesome-weather-up-wrap: wide -->