	...
	<?php if ($weather->background_image) { ?>
		<div class="awesome-weather-up-cover" style="background-image: url(<?php echo $weather->background_image; ?>);">
			...
			<?php if (isset($weather->data['current'])) { ?>
				<div class="awesome-weather-up-current-temp">

					<div class="awesome-weather-up-boxed-box awecf">
						<strong>
					...
					<?php if ($weather->show_stats) { ?>
						<div class="awe_highlow awecf awesome-weather-up-boxed-box">
						...
						<div class="awe_humidty awecf awesome-weather-up-boxed-box">
						...
						<div class="awe_wind awecf awesome-weather-up-boxed-box">
						...
						<div class="awe_sun awesome-weather-up-boxed-box awecf">
				...
				</div><!-- /.awesome-weather-up-current-temp -->
			<?php } ?>

			<?php if ($weather->forecast_days != "hide") { ?>
				<div class="awesome-weather-up-boxed-forecast awesome-weather-up-boxed-box awecf awe_days_<?php echo count($weather_forecast); ?>">
			...
			if ($weather->show_icons) {
				awe_extended_link($weather, "<div class='awesome-weather-up-boxed-box'><span><i class='wi wi-direction-up-right'></i></span>", "</div>");
			} else {
				awe_extended_link($weather, "<div class='awesome-weather-up-boxed-box'>", "</div>");
			}
			?>
...
</div><!-- /.awesome-weather-up-wrap: boxed -->