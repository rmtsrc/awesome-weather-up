...
// AWESOME WEATHER WIDGET UPDATED, WIDGET CLASS, SO MANY WIDGETS
class AwesomeWeatherWidget extends WP_Widget
{
	function __construct()
	{
		parent::__construct(false, $name = 'Awesome Weather Widget Updated 3.0.2');
	}
...
?>
		...
		<div id="awesome-weather-up-fields-<?php echo $this->id; ?>">

			<?php if ($provider == 'openweathermaps' and !$appid) { ?>
				<div style="background: #e85959; color: #fff; padding: 10px; margin-bottom: 10px;">
					<?php
					echo __("OpenWeatherMap requires an APP ID key to access their weather data.", 'awesome-weather-up');
					echo " <a href='https://openweathermap.org/appid' target='_blank' style='color: #fff;'>";
					echo __('Get your APPID', 'awesome-weather-up');
					echo "</a> ";
					echo __("and", 'awesome-weather-up');
					echo " <a href='options-general.php?page=awesome-weather-up&highlight=openweathermaps' target='_blank' style='color: #fff;'>";
					echo __("add it to the settings page.", 'awesome-weather-up');
					echo "</a> ";
					?>
				</div>
			<?php } ?>
			...
			<?php if ($provider == 'darksky' and !$darksky_key) { ?>
				<div style="background: #e85959; color: #fff; padding: 10px; margin-bottom: 10px;">
					<?php
					echo __("Dark Sky requires a Secret Key to access their weather data.", 'awesome-weather-up');
					echo " <a href='https://darksky.net/dev' target='_blank' style='color: #fff;'>";
					echo __('Get your Key', 'awesome-weather-up');
					echo "</a> ";
					echo __("and", 'awesome-weather-up');
					echo " <a href='options-general.php?page=awesome-weather-up&highlight=darksky' target='_blank' style='color: #fff;'>";
					echo __("add it to the settings page.", 'awesome-weather-up');
					echo "</a> ";
					?>
				</div>
			...
			<p>
				<label for="<?php echo $this->get_field_id('location'); ?>"><?php _e('Template:', 'awesome-weather-up'); ?></label><br>
				<select id="<?php echo $this->get_field_id('size'); ?>" name="<?php echo $this->get_field_name('size'); ?>" class="awesome-weather-up-size-select" data-widgetid="<?php echo $this->id; ?>">
			...
			<div id="custom-template-<?php echo $this->id; ?>-field" <?php if ($selected_size != "custom") echo " style='display:none;'"; ?>>
				<label for="<?php echo $this->get_field_id('custom_template_name'); ?>"><?php _e('Custom Template Filename:', 'awesome-weather-up'); ?></label> <small>(<?php _e('found in theme folder', 'awesome-weather-up'); ?>)</small><br>
			...
			<?php if ($provider == 'darksky') { ?>
				<p>
					<label for="<?php echo $this->get_field_id('location'); ?>"><?php _e('Search for Your Location:', 'awesome-weather-up'); ?> <span id="awe-latlng-spinner-<?php echo $this->get_field_id('location'); ?>" class="hidden"><img src="/wp-admin/images/spinner.gif" width="15" height="15"></span></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('owm_city_id'); ?>">
						<?php _e('Latitude,Longitude:', 'awesome-weather-up'); ?><br>
						<small style="line-height: 1em;">(<?php _e('use the location field above to geolocate.', 'awesome-weather-up'); ?>)</small>
					</label>
			...
			<?php } else { ?>
				...
				<p>
					<label for="<?php echo $this->get_field_id('location'); ?>"><?php _e('Search for Your Location:', 'awesome-weather-up'); ?> <span id="awe-owm-spinner-<?php echo $this->get_field_id('location'); ?>" class="hidden"><img src="/wp-admin/images/spinner.gif" width="15" height="15"></span></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('owm_city_id'); ?>">
						<?php _e('OpenWeatherMap City ID:', 'awesome-weather-up'); ?><br>
						<small>(<?php _e('use the location field above to find the ID for your city', 'awesome-weather-up'); ?>)</small>
					</label>
				...
				<script type="text/javascript">
					<?php if (!$owm_city_id) { ?>
						jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> #<?php echo $this->get_field_id('location'); ?>').trigger('keyup');
					<?php } ?>
				</script>
			<?php } ?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('override_title'); ?>"><?php _e('Banner Title:', 'awesome-weather-up'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('widget_title'); ?>"><?php _e('Widget Title: (optional)', 'awesome-weather-up'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('forecast_days'); ?>"><?php _e('Forecast:', 'awesome-weather-up'); ?></label> &nbsp;
				<select id="<?php echo $this->get_field_id('forecast_days'); ?>" name="<?php echo $this->get_field_name('forecast_days'); ?>">
					<?php for ($d = $forecasts_days_available; $d > 0; $d--) { ?>
						<option value="<?php echo $d; ?>" <?php if ($forecast_days == $d) echo " selected=\"selected\""; ?>> <?php echo sprintf(_n('%s Day', '%s Days', $d, 'awesome-weather-up'), $d); ?></option>
					<?php } ?>
					<option value="hide" <?php if ($forecast_days == 'hide') echo " selected=\"selected\""; ?>><?php _e("Don't Show", 'awesome-weather-up'); ?></option>
				</select>
			</p>

			<p>
				<label for="<?php echo $this->get_field_id('background'); ?>"><?php _e('Background Image:', 'awesome-weather-up'); ?></label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('background_by_weather'); ?>"><?php _e('Use Different Background Images Based on Weather', 'awesome-weather-up'); ?></label> <a href="https://halgatewood.com/docs/plugins/awesome-weather-up-widget/creating-different-backgrounds-for-different-weather" target="_blank">(?)</a> &nbsp;
			</p>

			<p>
				<label for="<?php echo $this->get_field_id('custom_bg_color'); ?>"><?php _e('Custom Background Color:', 'awesome-weather-up'); ?></label><br />
				<small><?php _e('overrides color changing', 'awesome-weather-up'); ?>: #7fb761 / rgba(0,0,0,0.5)</small>
			...
			<p>
				<label for="<?php echo $this->get_field_id('text_color'); ?>" style="display:block;"><?php _e('Text Color', 'awesome-weather-up'); ?></label>
			...
			<script type="text/javascript">
				jQuery(document).ready(function($) {
					jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> #<?php echo $this->get_field_id('text_color'); ?>').on('focus', function() {
						var parent = jQuery(this).parent();
						jQuery(this).wpColorPicker()
						parent.find('.wp-color-result').click();
					});

					jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> #<?php echo $this->get_field_id('text_color'); ?>').wpColorPicker()
				});
			</script>

			<p>
				<label for="<?php echo $this->get_field_id('units'); ?>"><?php _e('Units:', 'awesome-weather-up'); ?></label> &nbsp;
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('use_user_location'); ?>"><?php _e('Use User Location', 'awesome-weather-up'); ?></label>
			</p>
			<p id="<?php echo $this->get_field_id('allow_user_to_change'); ?>-wrap" <?php if (!$use_user_location) echo " class=\"hidden\""; ?>>
				...
				<label for="<?php echo $this->get_field_id('allow_user_to_change'); ?>"><?php _e('Allow User to Change the Location', 'awesome-weather-up'); ?></label>
			</p>
			<p id="<?php echo $this->get_field_id('skip_geolocate'); ?>-wrap" <?php if (!$allow_user_to_change) echo " class=\"hidden\""; ?>>
				...
				<label for="<?php echo $this->get_field_id('skip_geolocate'); ?>"><?php _e('Skip HTML5 Geolocation', 'awesome-weather-up'); ?></label>
			</p>


			<script type="text/javascript">
				jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> #<?php echo $this->get_field_id('use_user_location'); ?>').change(function() {
					if (!this.checked) {
						jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> span#<?php echo $this->get_field_id('units'); ?>-span').addClass('hidden');
						jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> p#<?php echo $this->get_field_id('allow_user_to_change'); ?>-wrap').addClass('hidden');
						jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> p#<?php echo $this->get_field_id('skip_geolocate'); ?>-wrap').addClass('hidden');
					} else {
						jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> span#<?php echo $this->get_field_id('units'); ?>-span').removeClass('hidden');
						jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> p#<?php echo $this->get_field_id('allow_user_to_change'); ?>-wrap').removeClass('hidden');

						if (document.getElementById('<?php echo $this->get_field_id('allow_user_to_change'); ?>').checked) {
							jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> p#<?php echo $this->get_field_id('skip_geolocate'); ?>-wrap').removeClass('hidden');
						}
					}
				});

				jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> #<?php echo $this->get_field_id('allow_user_to_change'); ?>').change(function() {
					if (this.checked) {
						jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> p#<?php echo $this->get_field_id('skip_geolocate'); ?>-wrap').removeClass('hidden');
					} else {
						jQuery('#awesome-weather-up-fields-<?php echo $this->id; ?> p#<?php echo $this->get_field_id('skip_geolocate'); ?>-wrap').addClass('hidden');
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_icons'); ?>"><?php _e('Show Weather Icons', 'awesome-weather-up'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('hide_stats'); ?>"><?php _e('Hide Stats', 'awesome-weather-up'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('hide_attribution'); ?>"><?php _e('Hide Weather Attribution', 'awesome-weather-up'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_link'); ?>"><?php _e('Link to Extended Forecast', 'awesome-weather-up'); ?></label>
			</p>

			<p>
				<label for="<?php echo $this->get_field_id('extended_url'); ?>"><?php _e('Custom Extended Forecast URL:', 'awesome-weather-up'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('extended_text'); ?>"><?php _e('Custom Extended Forecast Text:', 'awesome-weather-up'); ?></label>
			...
			<p style="text-transform: uppercase; font-size: 0.8em; font-weight: bold;"><?php _e('Advanced Options', 'awesome-weather-up'); ?></p>

			<p>
				<label for="<?php echo $this->get_field_id('locale'); ?>"><?php _e('Locale:', 'awesome-weather-up'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Widget ID:', 'awesome-weather-up'); ?></label>
