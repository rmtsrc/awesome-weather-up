...
function awesome_weather_get_weather_data_darksky(&$weather)
{
	...
	if (isset($city_data->currently)) {
		...
		if (isset($city_data->daily->data) and isset($city_data->daily->data[0])) {
			...
			if ($weather->units == 'ca') {
				$weather_data['current']['wind_speed_text'] = apply_filters('awesome_weather_wind_speed_text', __('km/h', 'awesome-weather-up'));
			} else if ($weather->units == 'uk2' or $weather->units == 'us') {
				$weather_data['current']['wind_speed_text'] = apply_filters('awesome_weather_wind_speed_text', __('mph', 'awesome-weather-up'));
			} else {
				$weather_data['current']['wind_speed_text'] = apply_filters('awesome_weather_wind_speed_text', __('m/s', 'awesome-weather-up'));
			}
...
function awesome_weather_build_daily_forecast_darksky(&$weather, $forecast_item)
{
	...
	if ($weather->units == 'ca') {
		$wind_speed_text = apply_filters('awesome_weather_wind_speed_text', __('km/h', 'awesome-weather-up'));
	} else if ($weather->units == 'uk2' or $weather->units == 'us') {
		$wind_speed_text = apply_filters('awesome_weather_wind_speed_text', __('mph', 'awesome-weather-up'));
	} else {
		$wind_speed_text = apply_filters('awesome_weather_wind_speed_text', __('m/s', 'awesome-weather-up'));
	}
